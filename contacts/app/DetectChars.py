...
def loadKNNDataAndTrainKNN():
    ...
    # try:
    npaClassifications = np.loadtxt(BASE_DIR+"//app//classifications.txt", np.float32)                  # read in training classifications
    ...
    try:
        npaFlattenedImages = np.loadtxt(BASE_DIR+"//app//flattened_images.txt", np.float32)                 # read in training images
    except:                                                                                 # if file could not be opened
